...
/// <summary>
/// Epic exchange-code embedded login dialog service.
/// </summary>
...
/// <summary>
/// Hosts the WebView2 exchange-code login window used by the Auth module.
/// </summary>
public sealed class EpicExchangeCodeLoginDialogService : IEpicExchangeCodeLoginDialogService
{
    private static readonly ILogger Logger = Log.ForContext<EpicExchangeCodeLoginDialogService>();
    ...
    /// <summary>
    /// 设置 XamlRoot。由 ShellPage 在加载时调用。
    /// </summary>
    public void SetXamlRoot(XamlRoot xamlRoot)
    {
        _xamlRoot = xamlRoot;
        Logger.Debug("EpicExchangeCodeLoginDialogService XamlRoot 已设置");
    }
    ...
    public async Task<Result<string>> ShowEpicExchangeCodeLoginAsync(AuthExchangeCodeLoginContext loginContext, CancellationToken ct = default)
    {
        ...
        if (_xamlRoot is null)
        {
            return Result.Fail<string>(new Error
            {
                ...
                TechnicalMessage = "EpicExchangeCodeLoginDialogService XamlRoot is not set before showing Epic embedded login window.",
                CanRetry = true,
